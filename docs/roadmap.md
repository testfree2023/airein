...
- **2026-07-18** `docs` 新增 [Agent Teams 需求分析报告](agent-teams-requirements-analysis.md)—— skills 自建团队（main=PM + 多 subagent）；明确不做会话外 watchdog；与 P007 切分。
