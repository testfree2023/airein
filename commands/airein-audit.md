# Airein Audit Command

Run a deterministic repository airein audit and return a prioritized scorecard.

## Usage

`/airein-audit [scope] [--format text|json]`
...
```bash
node scripts/airein-audit.js <scope> --format <text|json>
```
...
2) [Tool Coverage] Sync commands/airein-audit.md and .opencode/commands/airein-audit.md. (.opencode/commands/airein-audit.md)
