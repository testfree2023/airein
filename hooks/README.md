...
| **Doc file warning** | `Write` | Warns about non-standard `.md`/`.txt` files (allows README, CLAUDE, CONTRIBUTING, RELEASES, LICENSE, SKILL, docs/, skills/); cross-platform path handling | 0 (warns) |
